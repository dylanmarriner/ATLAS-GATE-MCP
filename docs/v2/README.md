...
**Version 2.0 is currently in development.** This documentation represents the planned features and architecture for the next major release.
...
- Enhanced governance dashboards
...
- Help validate technical accuracy
