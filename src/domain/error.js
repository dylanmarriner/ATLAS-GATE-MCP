...
/**
 * SystemError - The mandatory error schema for all MCP diagnostics.
...
/**
 * Helper to ensure any error is converted to a SystemError
 */
export function ensureSystemError(err, context = {}) {
    if (err instanceof SystemError) return err;

    return new SystemError({
        error_code: context.error_code || SYSTEM_ERROR_CODES.INTERNAL_ERROR,
